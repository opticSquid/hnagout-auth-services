...
public interface DeviceRepo extends JpaRepository<Device, UUID> {
    @Query(value = "select * from device where screen_width = :screenWidth and screen_height = :screenHeight and os = :os and user_agent = :userAgent and country = :country and user_id = :userId", nativeQuery = true)
